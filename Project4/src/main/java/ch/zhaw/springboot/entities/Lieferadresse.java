...
public class Lieferadresse { // 0: Regula Java class with attributes, constructor, methods
    ...
    public Lieferadresse (String strasse, String ort) {
        this.strasse = strasse;
        this.ort = ort;
    }

    public Lieferadresse() { // 3. Provide default constroctor if non-default is present
